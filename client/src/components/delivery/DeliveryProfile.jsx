      ...
      <Box sx={{ mb: 5, display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', flexWrap: 'wrap', gap: 3 }}>
        <Box>
          ...
          <Typography sx={{ color: COLORS.subtext, fontWeight: 500 }}>
            Manage your personal details and secure portal information
          </Typography>
        </Box>
        <Button 
          variant="contained" 
          ...
          <Grid item xs={12} md={4}>
            <Stack spacing={3}>
              <Paper elevation={0} sx={{ p: 5, borderRadius: 8, textAlign: 'center', bgcolor: COLORS.green1, border: `1px solid ${COLORS.border}`, position: 'relative', overflow: 'hidden' }}>
                ...
                <Typography variant="body2" sx={{ color: COLORS.blue2, fontWeight: 800, mb: 3, letterSpacing: 1, textTransform: 'uppercase', fontSize: '0.7rem' }}>Delivery Partner</Typography>
                <Chip 
                ...
                <CardContent sx={{ p: 3 }}>
                  ...
                  <Stack spacing={2}>
                    ...
                    <Box sx={{ display: 'flex', gap: 2, alignItems: 'center' }}>
                      ...
                      <Box>
                        <Typography variant="body2" sx={{ fontWeight: 700 }}>Courier ID: #DEL-{profile._id.slice(-4).toUpperCase()}</Typography>
