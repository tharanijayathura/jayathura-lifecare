...
const PHYSICAL_PHARMACY = {
  name: 'Jayathura LifeCare Physical Pharmacy',
  address: 'Kamburupitiya, Matara, Sri Lanka',
  city: 'Kamburupitiya'
};

const getDistanceForCity = (city) => {
